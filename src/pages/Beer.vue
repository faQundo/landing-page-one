  ...
  <div>
    <div class="page-header page-header-small">
      <parallax
        ...
        style="background-image: url('img/beer-landing-bg1.jpg')"
      >
      </parallax>
      <div class="content-center">
        <div class="container">
          <h1 class="title">Siempre mejor en compa{ñ}ia.</h1>
        ...
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto text-center">
            ...
            <h5 class="description">
              Somos un grupo de amigos apasionados por la cerveza. Nos encanta
              Lorem ipsum, dolor sit amet consectetur adipisicing elit.
              Perferendis praesentium iure itaque ratione cumque quam eius
              numquam sapiente, quasi sit facilis delectus expedita vel. Quo
              ipsum eaque enim aut dolore.
            </h5>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div
                ...
                style="background-image: url('img/beer-img1.jpg')"
              >
